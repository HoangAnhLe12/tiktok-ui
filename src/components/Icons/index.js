export const MessesgeIcon = ({ className, width = '2.6rem', height = '2.6rem' }) => (
   <svg
      fill="currentColor"
      className={className}
      viewBox="0 0 48 48"
...
export const FollowingIcon = ({ className, width = '2.8rem', height = '2.8rem' }) => (
   <svg
      fill="currentColor"
      className={className}
      width={width}
...
export const FollowingActiveIcon = ({ className, width = '2.8rem', height = '2.8rem' }) => (
   <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
      className={className}
...
export const FriendActiveIcon = ({ className, width = '3.2rem', height = '3.2rem' }) => (
   <svg
      width={width}
      className={className}
      height={height}
...
export const MessagesActiveIcon = ({ className, width = '2.6rem', height = '2.6rem' }) => (
   <svg
      width={width}
      className={className}
      height={height}
